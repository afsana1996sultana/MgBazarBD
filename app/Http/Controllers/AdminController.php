...
class AdminController extends Controller
{
    ...
    /*=================== Start Dashboard Methoed ===================*/
       public function Dashboard(){
    	...
    	return view('admin.index', compact('userCount', 'productCount', 'categoryCount', 'brandCount', 'vendorCount', 'orderCount', 'lowStockCount','todays_sale','monthly_sale','yearly_sale','stockCount','todaysStockIn','todaysStockOut','today_profit','monthly_profit','yearly_profit'));
    } // end method
