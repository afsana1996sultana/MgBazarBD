...
Route::prefix('admin')->middleware('admin')->group(function(){
	...
	Route::get('/career_active/{id}', [CareerController::class, 'active'])->name('career.active');
	Route::get('/career_inactive/{id}', [CareerController::class, 'inactive'])->name('career.in_active');
