...
Route::get('/career',[FrontendController::class, 'CareerPage'])->name('career');
Route::get('/career-executive-apply-from',[FrontendController::class, 'CareerExecutiveApply'])->name('career-executive-apply-from');
