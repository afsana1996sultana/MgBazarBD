                ...
                <table id="example" class="table table-bordered table-striped" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if(Auth::guard('admin')->user()->role != '2')
                                <td class="text-end">
                                    <a class="btn btn-md rounded font-sm" href="{{ route('brand.edit',$brand->id) }}">Edit</a>
                                    <a class="btn btn-md rounded font-sm bg-danger" href="{{ route('brand.delete',$brand->id) }}" id="delete">Delete</a>
                                </td>
                            @endif
                        </tr>
                        @endforeach
