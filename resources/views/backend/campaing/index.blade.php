                ...
                <table id="example" class="table table-bordered table-striped" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a class="btn btn-md rounded font-sm" href="{{ route('campaing.edit',$campaing->id) }}">Edit</a>
                                <a class="btn btn-md rounded font-sm bg-danger" href="{{ route('campaing.delete',$campaing->id) }}" id="delete">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
