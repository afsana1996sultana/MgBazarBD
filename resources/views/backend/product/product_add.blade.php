		        	...
		        	<div class="card-body">
		        		...
		        		<div class="row">
							...
							<div class="col-md-6 mb-4">
								...
								<a class="btn btn-sm float-end common-btn-color" data-bs-toggle="modal" data-bs-target="#category"><i class="fa-solid fa-plus text-white"></i></a>
								@php
									$selectedCategory = 0;
								@endphp
							...
							<div class="col-md-6 mb-4">
		        				<a type="button" class="btn btn-sm float-end common-btn-color" id="closeModal1" data-bs-toggle="modal" data-bs-target="#brand"><i class="fa-solid fa-plus text-white"></i></a>
	                           <label for="brand_id" class="col-form-label" style="font-weight: bold;">Brand:</label>
				                <div class="custom_select">
                                    <select class="form-control select-active w-100 form-select select-nice" name="brand_id" id="brand_id">
                                    	<option {{old('brand_id') ? '' : 'selected'}} value="0">--Select Brand--</option>
	                        ...
	                        <div class="col-md-6 mb-4">
								...
								<div class="custom_select">
									<select class="form-control select-active w-100 form-select select-nice" name="supplier_id" id="supplier_id">
										<option {{old('supplier_id') ? '' : 'selected'}} value="0">--Select Supplier--</option>
		        ...
		        <div class="card">
		        	...
		        	<div class="card-body">
                        ...
                        <div class="mb-4">
							...
							<small class="text-muted">These images are visible in the Product thumbnail. Use 500x500 or higher sizes images for better quality. But try to keep file size low as it'll increase page load time.</small>
