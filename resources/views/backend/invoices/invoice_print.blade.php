...
<body>
	<div>
		...
		<div style="padding: 0px 20px;">
            <table>
				<tr><td class="strong small gry-color">Bill to: {{ $order->name ?? 'Walk-in Customer' }}</td></tr>
				<tr><td class="gry-color small">Phone: {{ $order->phone ?? 'No phone' }}</td></tr>
				<tr>
			            ...
			            <td>
					        <table class="text-right small strong">
						        <tbody>
							        ...
							        <tr>
							            <th class="text-left" style="font-weight: 600; display: flex; font-size: 12px;">Grand Total</th>
