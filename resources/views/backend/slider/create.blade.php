		                ...
		                <div class="col-md-12">
		                    <form method="post" action="{{ route('slider.store') }}" enctype="multipart/form-data">
		                        ...
		                        <div class="mb-4">
		                            ...
		                            <small class="text-muted">These images are visible in the slider background. Use 1586x538 or higher sizes images for better quality. But try to keep file size low as it'll increase page load time.</small>
		                        </div>
