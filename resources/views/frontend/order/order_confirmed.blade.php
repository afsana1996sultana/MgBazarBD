                                        ...
                                        <div class="invoice-name">
                                            <div class="logo w-50">
                                                ...
                                                <div>
                                                    ...
                                                    <abbr title="Email">Hotline number: </abbr> 01819907330<br>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="invoice-number">
                                            ...
                                            <p class="invoice-addr-1 text-capitalize">
                                                <span title="Phone">Name:</span> {{ $order->name ?? '' }}<br>
                                                <span title="Phone">Phone:</span> {{ $order->phone ?? ''}}<br>
                                                <span title="Email">Email: </span>{{ $order->email ?? ''}}<br>
                                                <span title="Phone">Address:</span> {{ $order->address ?? '' }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
