            ...
            <div class="product-img">
                <a href="{{ route('product.details',$product->slug) }}">
                    @if($product->product_thumbnail && $product->product_thumbnail != '' && $product->product_thumbnail != 'Null')
                        <img class="default-img" data-original="{{ asset($product->product_thumbnail) }}" src="{{ asset($product->product_thumbnail) }}" alt="">
                    @else
                        <img class="img-lg mb-3" data-original="{{ asset('upload/no_image.jpg') }}" src="{{ asset('upload/no_image.jpg') }}" alt="">
                    @endif
                </a>
            </div>
        </div>
                ...
                <div class="product-card-bottom">
                    ...
                    <div class="add-cart">
	                    ...
	                    @else
	                        ...
	                        <input type="hidden" class="{{ $product->id }}-product_pname" value="{{ $product->name_en }}">
