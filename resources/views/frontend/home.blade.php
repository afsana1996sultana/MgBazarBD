...
@include('frontend.common.add_to_cart_modal')
	    ...
	    <div class="container wow animate__animated animate__fadeIn">
	        ...
	        <div class="carausel-10-columns-cover position-relative">
	            <div class="carausel-10-columns" id="carausel-10-columns">
	                ...
	                <div class="card-2 d-flex flex-column justify-content-center align-items-center wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
	                    <figure class="img-hover-scale overflow-hidden">
	                        <a href="{{ route('product.category', $cat->slug) }}">
	                        	@if($cat->image && $cat->image != '' && $cat->image != 'Null')
									<img class="default-img lazyload img-responsive" data-original="{{ asset($cat->image) }}" src="{{ asset('upload/product-default-sm.jpg') }}" alt="category image">
				                @else
				                    <img class="img-lg mb-3" src="{{ asset('upload/no_image.jpg') }}" alt="category default image">
				                @endif
	                        </a>
	                    </figure>
	                    <h6>
    	            ...
    	            <div class="col-lg-4 col-md-6">
    	                <div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay="0">
    	                    <a href="{{$banner->banner_url}}">
        	                    <img src="{{asset($banner->banner_img)}}" class="img-fluid" alt="banner img" style="height: 300px; width: 100%;">
	            ...
	            <ul class="nav nav-tabs links" id="myTab" role="tablist">
	                ...
	                @foreach(get_categories()->take(5) as $category)
						<li class="nav-item mb-1" role="presentation">
							<button class="nav-link" id="nav-tab-two_{{ $category->id }}" data-bs-toggle="tab" data-bs-target="#category{{ $category->id }}" type="button" role="tab" aria-selected="false">{{ $category->name_en}}</button>
						</li>
                    @endforeach
	            </ul>
	        </div>
	    ...
	    <div class="container">
	        <div class="section-title wow animate__animated animate__fadeIn">
	            ...
	            <ul class="nav nav-tabs links" id="myTab-2" role="tablist">
	                <li class="nav-item" role="presentation">
	                    <button class="nav-link active" id="nav-tab-one-1" data-bs-toggle="tab" data-bs-target="#tab-one-1" type="button" role="tab" aria-selected="true"></button>
	                </li>
	                <li class="nav-item" role="presentation">
	                    <button class="nav-link" id="nav-tab-two-1" data-bs-toggle="tab" data-bs-target="#tab-two-1" type="button" role="tab" aria-selected="false"></button>
	                </li>
	                <li class="nav-item" role="presentation">
	                    <button class="nav-link" id="nav-tab-three-1" data-bs-toggle="tab" data-bs-target="#tab-three-1" type="button" role="tab" aria-selected="false"></button>
	                </li>
	            </ul>
	        </div>
				...
				<div class="carausel-10-columns-cover position-relative">
					<div class="carausel-10-columns-vendors" id="carausel-10-columns-vendors">
						@foreach(get_vendors() as $vendor)
							<div class="card-2 mx-2 d-flex flex-column justify-content-center align-items-center wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
								<figure class="img-hover-scale overflow-hidden">
									<a href="{{ route('vendor.product', $vendor->slug) }}">
										@if($vendor->shop_profile && $vendor->shop_profile != '' && $vendor->shop_profile != 'Null')
											<img class="default-img" src="{{ asset($vendor->shop_profile) }}" alt="shop profile">
										@else
											<img class="img-lg mb-3" src="{{ asset('upload/no_image.jpg') }}" alt="shop profile default">
										@endif
									</a>
								</figure>
								<h6>
	...
	<section class="section-padding mb-30">
	    <div class="container">
	        <div class="row">
	            <div class="col-xl-3 col-lg-4 col-sm-6 mb-sm-5 mb-md-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
								...
								<figure class="col-sm-4 mb-0">
									<a href="{{ route('product.details',$product_top_selling->slug) }}">
										@if($product_top_selling->product_thumbnail && $product_top_selling->product_thumbnail != '' && $product_top_selling->product_thumbnail != 'Null')
	                                        <img class="default-img" src="{{ asset($product_top_selling->product_thumbnail) }}" alt="product thumbnail">
	                                    @else
	                                        <img class="img-lg mb-3" src="{{ asset('upload/no_image.jpg') }}" alt="no image">
	                                    @endif
									</a>
								</figure>
								<div class="col-sm-8 mb-0 text-center text-sm-start">
									<h6>
										<a href="{{ route('product.details',$product_top_selling->slug) }}">
											@if(session()->get('language') == 'bangla')
                                                <?php $selling_name_bn =  strip_tags(html_entity_decode($product_top_selling->name_bn))?>
                                                {{ Str::limit($selling_name_bn, $limit = 25, $end = '. . .') }}
                                            @else
                                                <?php $selling_name_en =  strip_tags(html_entity_decode($product_top_selling->name_en))?>
                                                {{ Str::limit($selling_name_en, $limit = 25, $end = '. . .') }}
                                            @endif
										</a>
									</h6>
	            ...
	            <div class="col-xl-3 col-lg-4 col-sm-6 mb-md-0 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
	                <h4 class="section-title style-1 mb-30 animated animated">
	                    @if(session()->get('language') == 'bangla')
	                        প্রবণতা পণ্য
	                    @else
	                    ...
	                    <article class="row align-items-center hover-up">
	                        <figure class="col-sm-4 mb-0">
	                            <a href="{{ route('product.details',$product_trending->slug) }}">
	                            	@if($product_trending->product_thumbnail && $product_trending->product_thumbnail != '' && $product_trending->product_thumbnail != 'Null')
                                        <img class="default-img" src="{{ asset($product_trending->product_thumbnail) }}" alt="product thumbnail">
                                    @else
                                        <img class="img-lg mb-3" src="{{ asset('upload/no_image.jpg') }}" alt="no image">
                                    @endif
	                            </a>
	                        ...
	                        <div class="col-sm-8 mb-0 text-center text-sm-start">
	                            <h6>
	                                <a href="{{ route('product.details',$product_trending->slug) }}">
	                                    @if(session()->get('language') == 'bangla')
                                            <?php $trending_name_bn =  strip_tags(html_entity_decode($product_trending->name_bn))?>
                                            {{ Str::limit($trending_name_bn, $limit = 25, $end = '. . .') }}
                                        @else
                                            <?php $trending_name_en =  strip_tags(html_entity_decode($product_trending->name_en))?>
                                            {{ Str::limit($trending_name_en, $limit = 25, $end = '. . .') }}
                                        @endif
	                                </a>
	                            </h6>
	                            <div class="product-rate-cover">
	                    ...
	                    <article class="row align-items-center hover-up">
	                        <figure class="col-md-4 mb-0">
	                            <a href="{{ route('product.details',$product_recently_add->slug) }}">
	                            	@if($product_recently_add->product_thumbnail && $product_recently_add->product_thumbnail != '' && $product_recently_add->product_thumbnail != 'Null')
                                        <img class="default-img" src="{{ asset($product_recently_add->product_thumbnail) }}" alt="product thumbnail">
                                    @else
                                        <img class="img-lg mb-3" src="{{ asset('upload/no_image.jpg') }}" alt="no image">
                                    @endif
	                            </a>
	                        ...
	                        <div class="col-sm-8 mb-0 text-center text-sm-start">
	                            <h6>
	                                <a href="{{ route('product.details',$product_recently_add->slug) }}">
										@if(session()->get('language') == 'bangla')
                                            <?php $recently_name_bn =  strip_tags(html_entity_decode($product_recently_add->name_bn))?>
                                            {{ Str::limit($recently_name_bn, $limit = 25, $end = '. . .') }}
                                        @else
                                            <?php $recently_name_en =  strip_tags(html_entity_decode($product_recently_add->name_en))?>
                                            {{ Str::limit($recently_name_en, $limit = 25, $end = '. . .') }}
                                        @endif
	                                </a>
	                            </h6>
	                            <div class="product-rate-cover">
	                    ...
	                    <article class="row align-items-center hover-up">
	                        <figure class="col-md-4 mb-0">
	                            <a href="{{ route('product.details',$product_top_rate->slug) }}">
	                            	@if($product_top_rate->product_thumbnail && $product_top_rate->product_thumbnail != '' && $product_top_rate->product_thumbnail != 'Null')
                                        <img class="default-img" src="{{ asset($product_top_rate->product_thumbnail) }}" alt="product thumbnail">
                                    @else
                                        <img class="img-lg mb-3" src="{{ asset('upload/no_image.jpg') }}" alt="no image">
                                    @endif
	                            </a>
	                        ...
	                        <div class="col-sm-8 mb-0 text-center text-sm-start">
	                            <h6>
	                                <a href="{{ route('product.details',$product_top_rate->slug) }}">
										@if(session()->get('language') == 'bangla')
                                            <?php $top_name_bn =  strip_tags(html_entity_decode($product_top_rate->name_bn))?>
                                            {{ Str::limit($top_name_bn, $limit = 25, $end = '. . .') }}
                                        @else
                                            <?php $top_name_en =  strip_tags(html_entity_decode($product_top_rate->name_en))?>
                                            {{ Str::limit($top_name_en, $limit = 25, $end = '. . .') }}
                                        @endif
									</a>
	                            </h6>
	                            <div class="product-rate-cover">
