                                ...
                                <li>
                                    <a href="{{ route('product.category', $category->slug) }}">
                                    	...
                                    	@if(session()->get('language') == 'bangla')
                                            {!! \Illuminate\Support\Str::words(strip_tags($category->name_bn), 3,'....')  !!}
                                        @else
                                        {!! \Illuminate\Support\Str::words(strip_tags($category->name_en), 3,'....')  !!}
                                        @endif
                                	</a>
                                </li>
                                @endforeach
        ...
        <div class="container wow animate__animated animate__fadeIn">
            ...
            <div class="carausel-10-columns-cover position-relative">
                <div class="carausel-10-columns" id="carausel-10-columns">
                    ...
                    <div class="single__feature card-2 bg-9 d-flex flex-column justify-content-center align-items-center wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
