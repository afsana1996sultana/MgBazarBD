<footer class="main footer-dark">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="position-relative newsletter-inner">
                        ...
                        @if(get_footer_banner())
                            <img src="{{asset(get_footer_banner()->banner_img)}}" alt="footer banner">
                        @endif
                    </div>
                </div>
            </div>
    ...
    <section class="featured section-padding">
        <div class="container">
            <div class="row">
                <div class="col-xl-1-5 col-md-4 col-12 col-sm-6 mb-md-4 mb-xl-0">
                    <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="banner-icon">
                            <img src="{{asset('frontend/assets/imgs/theme/icons/i-1.png')}}" alt="best prices">
                        </div>
                ...
                <div class="col-xl-1-5 col-md-4 col-12 col-sm-6">
                    <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <div class="banner-icon">
                            <img src="{{asset('frontend/assets/imgs/theme/icons/i-2.png')}}" alt="free delivery">
                        </div>
                        <div class="banner-text">
                ...
                <div class="col-xl-1-5 col-md-4 col-12 col-sm-6">
                    <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        <div class="banner-icon">
                            <img src="{{asset('frontend/assets/imgs/theme/icons/i-3.png')}}" alt="great daily deal">
                        </div>
                        <div class="banner-text">
                ...
                <div class="col-xl-1-5 col-md-4 col-12 col-sm-6">
                    <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        <div class="banner-icon">
                            <img src="{{asset('frontend/assets/imgs/theme/icons/i-4.png')}}" alt="">
                        </div>
                        <div class="banner-text">
                ...
                <div class="col-xl-1-5 col-md-4 col-12 col-sm-6">
                    <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                        <div class="banner-icon">
                            <img src="{{asset('frontend/assets/imgs/theme/icons/i-5.png')}}" alt="">
                        </div>
                        <div class="banner-text">
                ...
                <div class="col-xl-1-5 col-md-4 col-12 col-sm-6 d-xl-none">
                    <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                        <div class="banner-icon">
                            <img src="{{asset('frontend/assets/imgs/theme/icons/i-6.png')}}" alt="">
                        </div>
                        <div class="banner-text">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-6 col-12">
                    <div class="row justify-content-between">
                        ...
                        <div class="ms-xl-auto col-md-5 col-12 mr-0 d-sm-none d-md-block">
                            <div class="footer-link-widget wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                                <h4 class="widget-title">CONTACT INFO</h4>
                                <ul class="contact-infor">
                                    <li><i class="fa-sharp fa-solid fa-location-dot me-2 text-white"></i><strong>Address: </strong> <span>{{ get_setting('business_address')->value ?? '' }}</span></li>
                                    <li><i class="fa-solid fa-phone me-2 text-white"></i><strong>Call Us: </strong><a href="tel:{{ get_setting('phone')->value ?? '' }}">{{ get_setting('phone')->value ?? '' }}</a></li>
                                    <li><i class="fa-regular fa-envelope me-2 text-white"></i><strong>Email: </strong><a href="mailto:{{ get_setting('email')->value ?? '' }}">{{ get_setting('email')->value ?? '' }}</a></li>
                                    <li><i class="fa-solid fa-business-time me-2 text-white"></i><strong>Hours:</strong><span> {{ get_setting('business_hours')->value ?? '' }}</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12 mr-0 d-sm-block d-md-none">
                    <div class="footer-link-widget wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <h4 class="widget-title">CONTACT INFO</h4>
                        <ul class="contact-infor">
                            <li><i class="fa-sharp fa-solid fa-location-dot me-2 text-white"></i><strong>Address: </strong> <span>{{ get_setting('business_address')->value ?? '' }}</span></li>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">
                    <div class="mobile-social-icon justify-content-center">
                        <h6>Follow Us</h6>
                        <a href="{{ get_setting('facebook_url')->value ?? '' }}"><img src="{{asset('frontend/assets/imgs/theme/icons/icon-facebook-white.svg')}}" alt=""></a>
                        <a href="{{ get_setting('twitter_url')->value ?? '' }}"><img src="{{asset('frontend/assets/imgs/theme/icons/icon-twitter-white.svg')}}" alt=""></a>
                        <a href="{{ get_setting('instagram_url')->value ?? '' }}"><img src="{{asset('frontend/assets/imgs/theme/icons/icon-instagram-white.svg')}}" alt=""></a>
                        <a href="{{ get_setting('pinterest_url')->value ?? '' }}"><img src="{{asset('frontend/assets/imgs/theme/icons/icon-pinterest-white.svg')}}" alt=""></a>
                        <a href="{{ get_setting('youtube_url')->value ?? '' }}"><img src="{{asset('frontend/assets/imgs/theme/icons/icon-youtube-white.svg')}}" alt=""></a>
                    </div>
                    <p class="font-sm">
                        Developed by:
    ...
    <div class="row align-items-center gutters-5">
        ...
        <div class="col mobile_bottom_nav_col">
            ...
            <a href="{{ route('login') }}" class="text-reset d-block text-center pb-2 pt-3">
                <span class="d-block mx-auto">
                    <img src="{{ asset('frontend/assets/imgs/avatar-place.png') }}" class="rounded-circle mobile_bottom_nav_account" alt="">
                </span>
                <span class="d-block fs-10 fw-600">Account</span>
            </a>
            @endif
