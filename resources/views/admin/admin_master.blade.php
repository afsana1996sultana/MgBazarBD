...
<html lang="en">
    <head>
        ...
        <!-- Template CSS -->
        <link href="{{ asset('backend/assets/css/main.css?v=1.1') }}" rel="stylesheet">
        <!-- Custom CSS -->
        <link href="{{ asset('backend/assets/css/custom.css') }}" rel="stylesheet">
        <!-- toastr css -->
        <link rel="stylesheet" href="{{ asset('backend/assets/css/toastr.min.css') }}">
        <!-- Color Picker -->
        <link href="{{ asset('backend/assets/css/bootstrap-colorpicker.min.css') }}" rel="stylesheet">
        ...
        <!-- Datatable CSS -->
        <!--<link rel="stylesheet" href="{{ asset('backend/datatable/css/jquery.dataTables.css ') }}">-->
    ...
    <body>
        ...
        <script src="{{ asset('backend/assets/bootstrap-tags/bootstrap-tagsinput.min.js ') }}"></script>
